...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Bagon1 = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_BAGON, // Palette dynamique pour overworld
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 32,
    .height = 32,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Fangs1 = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_FANG, // Palette dynamique pour overworld
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 2048,
    .width = 32,
    .height = 64,
