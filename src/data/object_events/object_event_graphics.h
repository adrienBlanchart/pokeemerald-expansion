...
const u32 gObjectEventPic_EnemySalamenceMega[] = INCBIN_COMP("graphics/pokemon/salamence/mega/overworld.4bpp");
const u16 gObjectEventPal_EnemySalamenceMega[] = INCBIN_U16("graphics/pokemon/salamence/mega/overworld_normal.gbapal");
